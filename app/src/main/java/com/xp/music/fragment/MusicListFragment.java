...
import com.xp.music.network.HttpManager;
...
/**
 * Created by Love ZZA on 2020-11-07.
 */
public class MusicListFragment extends MyBaseFragment implements SwipeRefreshLayout.OnRefreshListener, MusicGetCallback, MusicOnclickCallback {
    ...
    public void onclick(MusicListInfo data) {
        ((MainActivity) requireActivity()).playMusic(data);
    }
}
